...
class FunctionsViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        // 调用方式
        joinTwo(ssString: "hello", rsString: "world", sjoiner: ",") // prints "hello,world"
        
        // 可以不使用快捷方式
        func joinThree(threeStr: String, threeString: String, threeJoiner joiner: String) -> String {
            return threeStr + joiner + threeString
        }
        joinThree("hello", "world", threeJoiner: ",")// prints "hello,world"
        ...
        func joinFive(lhsString: String, rhsString: String, withJoiner: String = " ") -> String {
            return lhsString + withJoiner + rhsString
        }
        joinFive("hello", "world", withJoiner: "-")// // prints "hello-world"
