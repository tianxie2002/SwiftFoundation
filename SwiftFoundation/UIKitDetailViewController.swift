...
class UIKitDetailViewController: BaseViewController ,UIPickerViewDataSource, UIPickerViewDelegate,UIActionSheetDelegate{
...
//        var alert = UIAlertController(title: "Title", message: String(format: "Result = %i", 22), preferredStyle: UIAlertControllerStyle.Alert)
